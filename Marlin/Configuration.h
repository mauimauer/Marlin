...
#define STRING_CONFIG_H_AUTHOR "(mauimauer, Ender-3)" // Who made the changes.
...
#define MACHINE_UUID "0dd83223-e198-4748-bf37-df06936f8c6c"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 (Microswiss)
  #define DEFAULT_Kp 30.93
  #define DEFAULT_Ki 3.33
  #define DEFAULT_Kd 71.83

  // Creality Ender-3 (Stock)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80*2, 80*2, 400*2, 103.33*2 } // 1/32 microstepping
